...
export class AuthService {
  ...
  checkUserName() {
    return this.socket.fromEvent('check-user-name--' + this.deviceSTR)//.subscribe((data: any) => {
    //   if (data.msg) {
    //     return true;
    //   }
    //   else {
  ...
  error(){
    return this.socket.fromEvent('error' + String(this.deviceSTR))//.subscribe((data: any) => {
